                    ...
                    <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                        ...
                        <a class="dropdown-item d-flex align-items-center" href="#">
                            ...
                            <div>
                                ...
                                Spending Alert: Unusually high account activity detected
                            </div>
                        </a>
                ...
                <li class="nav-item dropdown no-arrow mx-1">
                    ...
                    <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                        ...
                        <a class="dropdown-item d-flex align-items-center" href="#">
                            ...
                            <div>
                                <div class="text-truncate">New appointment request received</div>
                                <div class="small text-gray-500">Patient · 2h ago</div>
                            </div>
                        </a>
