            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-7 col-12 text-center mx-auto">
                        ...
                        <a class="custom-btn btn button button--atlas smoothscroll me-3 bg-primary"
                            href="#intro-section">
                            <span>About Us</span>
            ...
            <div class="container">
                <div class="row justify-content-lg-center align-items-center">
                    ...
                    <div class="col-lg-6 col-12">
                        ...
                        <p><a href="#">Tooth Repair Dental Clinic</a> is committed to providing high-quality and
                            affordable dental care in Malasiqui, Pangasinan. Our clinic offers a comfortable and
                            professional environment to enhance patient experience.</p>
                        <p>We prioritize modern dental techniques and patient-centered care to ensure a safe and
                            effective treatment for everyone. Please <a
                                href="mailto:toothrepairdentalclinic@gmail.com">contact us</a> for more information or
                            to book an appointment. Thank you.</p>
                    ...
                    <div class="col-lg-6 col-12 custom-block-wrap">
                        <img src="images/male-wearing-apron-female-white-t-shirt-smiling-broadly-being-glad-clean.png"
                            class="img-fluid" alt="Dental Care Team">
                                            ...
                                            <a href="landing_services.php">
                                                ...
                                                <?php else: ?>
                                                    <img src="images/services/default-service.jpg"
                                                        class="services-image img-fluid" alt="Default service image">
                                                    <img src="images/services/default-service.jpg"
                                                        class="services-image services-image-hover img-fluid"
                                    ...
                                    <div class="col-lg-7 col-md-7 col-12 d-flex align-items-center">
                                        <div class="services-info mt-4 mt-lg-0 mt-md-0">
                                            ...
                                            <div class="d-flex flex-wrap align-items-center">
                                                ...
                                                <a href="landing_services.php"
                                                    class="custom-btn btn button button--atlas mt-2 ms-auto bg-primary">
