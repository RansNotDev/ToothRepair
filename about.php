...
<html lang="en">
    ...
    <?php include 'headerlanding.php'; ?>
        ...
        <main>
            ...
            <section class="banner-section d-flex justify-content-center align-items-end" style="min-height: 100px;" aria-labelledby="about-banner-heading">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-7 col-12">
                            <h1 id="about-banner-heading" class="text-white mb-lg-0" style="font-size: 2rem;">About Us</h1>
                        </div>
            ...
            <section class="section-padding" aria-labelledby="about-content-heading">
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-lg-6 col-12">
                            <div class="about-image-wrap" style="max-width: 600px;">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="featured-block">
                                <h2 id="about-content-heading" class="mb-4 text-primary">Professional Dental Care Since 2015</h2>
